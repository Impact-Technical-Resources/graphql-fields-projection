...
describe('Testing removePathCollision function', () => {
  ...
  it('Test case 9', () => {
    const input = [
      ...
      'field1-10.child2.child1',
      'field1-10.child2.child3.child4',
      'field1-11.child1.child1',
    ...
    const expected = {
      ...
      'field1-10.child2.child1': 1,
      'field1-10.child2.child3.child4': 1,
      'field1-11.child1.child1': 1,
